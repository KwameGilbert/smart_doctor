    ...
    <SafeAreaView className="flex-1 bg-background dark:bg-background-dark" edges={["top"]}>
      ...
      >
        <View style={styles.modalOverlay}>
          <View className="bg-surface dark:bg-surface-dark rounded-t-[40px] px-6 pt-6 pb-10 w-full max-h-[85%] absolute bottom-0 shadow-2xl">
            {/* Header */}
            <View className="flex-row justify-between items-center mb-6">
              <Text className="text-lg font-bold text-text-main dark:text-text-main-dark">Reschedule Appointment</Text>
              <TouchableOpacity
                onPress={() => setReschedulingAppointment(null)}
                className="w-8 h-8 rounded-full bg-background dark:bg-background-dark items-center justify-center"
              >
